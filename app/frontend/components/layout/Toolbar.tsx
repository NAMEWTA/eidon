 ...
 * 下拉菜单经 createPortal 挂到 <body>，用 fixed 定位从按钮 rect 计算。
 * emits→回调 props；ref→useState/useRef；onMounted/onBeforeUnmount→mount effect。
 */
import { useEffect, useRef, useState } from 'react';
import { createPortal } from 'react-dom';
import { Icon } from '../shared/Icons';
import { PomodoroPopover } from '../features/PomodoroPopover';
...
import { open as openFileDialog } from '@bridge/ipc/dialog';
