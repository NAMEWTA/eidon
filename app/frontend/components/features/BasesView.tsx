/**
 * BasesView.tsx — Bases 风格 YAML properties 表格视图（v2.0 F6，从 BasesView 迁移）。
 *
 ...
 *
 * 实现要点：filters 数组 → useState + 不可变更新；派生值 → useMemo；
...
import { BASES_CLOSE_EVENT } from '../../hooks/useBasesView';
