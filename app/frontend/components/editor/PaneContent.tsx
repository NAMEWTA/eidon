...
import { openPathExternal } from '@bridge/ipc/opener';
...
function AssetPane({ tab }: { tab: Tab }) {
  const { t } = useI18n();
  const src = tab.filePath ? toAssetUrl(tab.filePath) : '';
    ...
    <div className="pane-content">
      ...
      {showPreview && tab && (
        <div className="pane pane--preview">
          {/* onOpenPath 复刻预览内部直接 files.openPath 的行为：普通预览/分屏窗格里相对链接可点开 */}
