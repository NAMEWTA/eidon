 ...
 *
 * Pure data utilities over the workspace index. No DOM access — these
 * helpers feed `BasesView`. The single source of truth is the
...
export const SAVED_VIEWS_KEY = 'eidon.basesViews.v1';
