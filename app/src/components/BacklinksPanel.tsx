/**
 * BacklinksPanel.tsx — 反向链接面板（从 BacklinksPanel.vue 迁移）。
    ...
    <div className="backlinks">
      ...
      {loading ? (
        ...
        <ul className="backlinks__list">
          {refs.map((r, i) => (
            <li key={`${r.from_path}-${r.line}-${i}`} className="backlinks__item">
              <button className="backlinks__row" onClick={() => openBacklink(r)}>
                <div className="backlinks__file">{r.from_name}</div>
