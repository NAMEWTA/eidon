...
export interface ImageExportOptions {
  /** When true, append a "Created with EIDON" footer.
...
const IMAGE_CSS = `
  ...
  .img-page {
    ...
    max-width: 800px;
    min-width: 480px;
    /* Bottom padding is set per-export based on whether the EIDON
...
export async function markdownToImageBlob(
  ...
  if (opts.branding) {
    ...
    footer.innerHTML = `Created with <span class="brand">EIDON</span>`;
